...
#include <semaforr/spatial/FORRRegion.hpp>
#include <semaforr/spatial/FORRExit.hpp>
#include <semaforr/spatial/FORRDoors.hpp>
#include <semaforr/spatial/Aggregate.hpp>
#include <map>
#include <memory>
#include <algorithm>
#include <queue>
