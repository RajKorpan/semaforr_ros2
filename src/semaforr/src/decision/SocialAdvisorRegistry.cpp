  ...
  SocialAdvisorRegistryConfiguration configuration)
{
  ...
  configuration.risk.objective =
    LearnedCrowdObjective::AvoidEncounterRisk;
  configuration.flow.objective =
    LearnedCrowdObjective::PreferFollowingFlow;

  registry.registerFactory(
    "social_navigation",
    [value = configuration.live] {
